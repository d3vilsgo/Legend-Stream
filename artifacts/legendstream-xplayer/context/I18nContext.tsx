...
const dictionaries: Record<AppLanguage, Dictionary> = {
  tr: {
    ...
    tapToLoad: "Yüklemek için dokun", categoryCount: "{count} kategori", channels: "{count} kanal", titles: "{count} içerik", seriesCount: "{count} dizi",
    ...
    m3uNoGroups: "Bu M3U listesi kategori bilgisi içermiyor.", providerOrder: "Yayıncı sırası", credentialsMissing: "Kimlik bilgileri eksik — yeniden gir",
    historySaveFailed: "İzleme geçmişi kaydedilemedi.", categoryNotSelected: "Kategori seçilmedi",
    selectCategory: "Bir kategori seçin", selectCategoryHint: "Yayınları görmek için kategori menüsünden bir seçim yapın.",
    selectSeason: "Bir sezon seçin", seasonHasNoEpisodes: "Bu sezonda bölüm bulunamadı.",
  },
  en: {
    ...
    tapToLoad: "Tap to load", categoryCount: "{count} categories", channels: "{count} channels", titles: "{count} titles", seriesCount: "{count} series",
    ...
    m3uNoGroups: "This M3U playlist does not contain category metadata.", providerOrder: "Provider order", credentialsMissing: "Credentials missing — enter again",
    historySaveFailed: "Watch history could not be saved.", categoryNotSelected: "No category selected",
    selectCategory: "Select a category", selectCategoryHint: "Choose a category from the menu to view channels.",
    selectSeason: "Select a season", seasonHasNoEpisodes: "No episodes were found in this season.",
  },
  de: {
